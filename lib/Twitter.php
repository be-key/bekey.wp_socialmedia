...
var $url = 'https://api.twitter.com/1.1/';
    var $outputFormats = array('text', 'json', 'array', 'object');
    ...
    public function __construct(){
		...
		$config = array(
			'consumer_key' => 'IhVq8hfg64bDqYSXvQ',
			'consumer_secret' => 'gdoV99JzK5mJgOBI55uFjXtuaHNCNn1ItT5qClEvlY',
			'oauth_token' => get_option('twitter_oauth_token'),
			'oauth_token_secret' => get_option('twitter_oauth_token_secret'),
